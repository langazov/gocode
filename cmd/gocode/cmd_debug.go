...
func debugV2Command() *clix.Command {
	return &clix.Command{Name: "v2", Describe: "debug v2 catalog and built-in plugins", Run: func(a *clix.Args) error {
		return notImplemented("gocode debug v2")
	}}
}
...
func debugAgentCommand() *clix.Command {
	return &clix.Command{
		...
		Run: func(a *clix.Args) error {
			...
			if a.String("tool") != "" {
				return notImplemented("gocode debug agent --tool")
			}
			return nil
		},
	}
...
func debugSnapshotCommand() *clix.Command {
	...
	return &clix.Command{
		...
		Demand:   true,
		Sub: []*clix.Command{
			{Name: "track", Describe: "track current snapshot state", Run: func(a *clix.Args) error { return notImplemented("gocode debug snapshot track") }},
			{Name: "patch", Describe: "show patch for a snapshot hash", Positionals: hashPositional, Run: func(a *clix.Args) error { return notImplemented("gocode debug snapshot patch") }},
			{Name: "diff", Describe: "show diff for a snapshot hash", Positionals: hashPositional, Run: func(a *clix.Args) error { return notImplemented("gocode debug snapshot diff") }},
		},
	}
}
...
func debugFileCommand() *clix.Command {
	...
	return &clix.Command{
		...
		Demand:   true,
		Sub: []*clix.Command{
			{Name: "read", Describe: "read file contents as JSON", Positionals: pathPositional, Run: func(a *clix.Args) error { return notImplemented("gocode debug file read") }},
			{Name: "list", Describe: "list files in a directory", Positionals: pathPositional, Run: func(a *clix.Args) error { return notImplemented("gocode debug file list") }},
			{Name: "search", Describe: "search files by query", Positionals: queryPositional, Run: func(a *clix.Args) error { return notImplemented("gocode debug file search") }},
		},
	}
}
...
func debugRipgrepCommand() *clix.Command {
	return &clix.Command{
		...
		Sub: []*clix.Command{
			...
			}, Run: func(a *clix.Args) error { return notImplemented("gocode debug rg files") }},
			{Name: "search", Describe: "search file contents using ripgrep",
				...
				Flags: []clix.Flag{
					...
					{Name: "limit", Kind: clix.KindNumber, Describe: "Limit number of results"},
				}, Run: func(a *clix.Args) error { return notImplemented("gocode debug rg search") }},
		},
	}
}
	...
	return &clix.Command{
		...
		Sub: []*clix.Command{
			...
			{Name: "symbols", Describe: "search workspace symbols",
				...
				Run:         func(a *clix.Args) error { return notImplemented("gocode debug lsp symbols") }},
			{Name: "document-symbols", Describe: "get symbols from a document",
				Positionals: []clix.Positional{{Name: "uri", Required: true}},
				Run:         func(a *clix.Args) error { return notImplemented("gocode debug lsp document-symbols") }},
		},
	}
}
