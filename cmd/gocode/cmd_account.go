	...
	return &clix.Command{
		...
		Sub: []*clix.Command{
			{Name: "login", Describe: "log in to console", Positionals: []clix.Positional{{Name: "url", Describe: "server URL"}},
				Run: func(a *clix.Args) error { return notImplemented("gocode console login") }},
			{Name: "logout", Describe: "log out from console", Positionals: []clix.Positional{{Name: "email", Describe: "account email to log out from"}},
				Run: func(a *clix.Args) error { return notImplemented("gocode console logout") }},
			{Name: "switch", Describe: "switch active org", Run: func(a *clix.Args) error { return notImplemented("gocode console switch") }},
			{Name: "orgs", Describe: "list orgs", Run: func(a *clix.Args) error { return notImplemented("gocode console orgs") }},
			{Name: "open", Describe: "open active console account", Run: func(a *clix.Args) error { return notImplemented("gocode console open") }},
		},
	}
}
