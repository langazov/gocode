...
What syncs: the global config, the theme you picked in the TUI, and the
project `gocode.json` of repos you open (matched by git remote). What never
...
Signing out (`gocode logout`) removes the local sync key.
